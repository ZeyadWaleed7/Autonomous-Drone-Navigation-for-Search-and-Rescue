...
print("BFS Path : ", bfs)
print("BFS Execution Time:", bfs_end_time - bfs_start_time, "seconds")
print("BFS Peak memory usage:", bfs_peak / 10 ** 6, "MB")
...
print("DFS Path : ", dfs)
print("DFS Execution Time:", dfs_end_time - dfs_start_time, "seconds")
print("DFS Peak memory usage:", dfs_peak / 10 ** 6, "MB")
...
print("UCS Path : ", ucs)
print("UCS Execution Time:", ucs_end_time - ucs_start_time, "seconds")
print("UCS Peak memory usage:", ucs_peak / 10 ** 6, "MB")
...
print("IDS Path : ", ids)
print("IDS Execution Time:", ids_end_time - ids_start_time, "seconds")
print("IDS Peak memory usage:", ids_peak / 10 ** 6, "MB")
...
print("A* Execution Time:", a_star_end_time - a_star_start_time, "seconds")
print("A* Peak memory usage:", A_peak / 10 ** 6, "MB")
...
print("Greedy Execution Time:", greedy_end_time - greedy_start_time, "seconds")
print("Greedy Peak memory usage:", greedy_peak / 10 ** 6, "MB")
...
print("Simulated Annealing Execution Time:", end_time - start_time, "seconds")
print("Simulated Annealing Peak memory usage:", peak / 10 ** 6, "MB")
...
print("Genetic Execution Time:", gen_end_time - gen_start_time, "seconds")
print("Genetic memory usage:", gen_peak / 10 ** 6, "MB")
...
print("Hill Climbing Execution Time:", Hill_Climbing_end_time - Hill_Climbing_start_time, "seconds")
print("Hill Climbing Peak memory usage:", Hill_Climbing_peak / 10 ** 6, "MB")
